  ...
  public: {
    Tables: {
      ...
      feed_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "feed_events_author_id_fkey"
            columns: ["author_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "feed_events_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
      ...
      wiki_documents: {
        ...
        Relationships: [
          {
            foreignKeyName: "wiki_documents_author_id_fkey"
            columns: ["author_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "wiki_documents_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      wiki_versions: {
        ...
        Relationships: [
          {
            foreignKeyName: "wiki_versions_author_id_fkey"
            columns: ["author_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "wiki_versions_document_id_fkey"
            columns: ["document_id"]
            isOneToOne: false
    ...
    Enums: {
      app_role: "root" | "admin" | "leader" | "member"
    }
    CompositeTypes: {
      [_ in never]: never
    }
